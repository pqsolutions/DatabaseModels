...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForPrePNDTCounselling' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForPrePNDTCounselling
END
GO
CREATE TRIGGER TR_AuditTrailForPrePNDTCounselling ON Tbl_PrePNDTCounselling FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_PrePNDTCounselling'
