...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSubjectPregnancy' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSubjectPregnancy
END
GO
CREATE TRIGGER TR_AuditTrailForSubjectPregnancy ON Tbl_SubjectPregnancyDetail FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_SubjectPregnancyDetail'
