...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForMTPReferal' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForMTPReferal
END
GO
CREATE TRIGGER TR_AuditTrailForMTPReferal ON Tbl_MTPReferal FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_MTPReferal'
