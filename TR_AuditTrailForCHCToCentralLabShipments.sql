...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForCHCToCentralLabShipments' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForCHCToCentralLabShipments
END
GO
CREATE TRIGGER TR_AuditTrailForCHCToCentralLabShipments ON Tbl_CHCShipments FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_CHCShipments'
