...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForHPLCStaging' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForHPLCStaging
END
GO
CREATE TRIGGER TR_AuditTrailForHPLCStaging ON Tbl_HPLCTestedDetail FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_HPLCTestedDetail'
