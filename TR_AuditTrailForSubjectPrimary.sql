...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSubjectPrimary' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSubjectPrimary
END
GO
CREATE TRIGGER TR_AuditTrailForSubjectPrimary ON Tbl_SubjectPrimaryDetail FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_SubjectPrimaryDetail'
