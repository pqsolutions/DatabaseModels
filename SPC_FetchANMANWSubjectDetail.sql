...
GO
IF EXISTS (Select 1 from sys.objects where name='SPC_FetchANMANWSubjectDetail' and [type] = 'p')
Begin
	DROP PROCEDURE SPC_FetchANMANWSubjectDetail 
End
GO
CREATE PROCEDURE [dbo].[SPC_FetchANMANWSubjectDetail]
(
	@ANMID INT
	,@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
