...
GO
/****** Object:  Trigger [dbo].[TR_AuditTrailForPNDTestNew]    Script Date: 23-03-2021 09:18:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[TR_AuditTrailForPNDTestNew] ON [dbo].[Tbl_PNDTestNew] FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_PNDTestNew'
