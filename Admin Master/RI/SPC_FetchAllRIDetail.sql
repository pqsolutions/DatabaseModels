...
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_FetchAllRIDetail' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_FetchAllRIDetail
END
GO
CREATE Procedure [dbo].[SPC_FetchAllRIDetail] 
AS
BEGIN
	SELECT R.[ID]
		,R.[RI_gov_code]
