...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForPostPNDTCounselling' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForPostPNDTCounselling
END
GO
CREATE TRIGGER TR_AuditTrailForPostPNDTCounselling ON Tbl_PostPNDTCounselling FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_PostPNDTCounselling'
