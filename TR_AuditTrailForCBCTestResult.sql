...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForCBCTestResult' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForCBCTestResult
END
GO
CREATE TRIGGER TR_AuditTrailForCBCTestResult ON Tbl_CBCTestResult FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_CBCTestResult'
