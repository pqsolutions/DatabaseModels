...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSubjectAddress' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSubjectAddress
END
GO
CREATE TRIGGER TR_AuditTrailForSubjectAddress ON Tbl_SubjectAddressDetail FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_SubjectAddressDetail'
