...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForANMCHCShipments' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForANMCHCShipments
END
GO
CREATE TRIGGER TR_AuditTrailForANMCHCShipments ON Tbl_ANMCHCShipments FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_ANMCHCShipments'
