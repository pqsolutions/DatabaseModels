...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForPNDTest' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForPNDTest
END
GO
CREATE TRIGGER TR_AuditTrailForPNDTest ON Tbl_PNDTest FOR UPDATE,INSERT
AS
