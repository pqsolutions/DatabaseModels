...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForPostPNDTScheduling' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForPostPNDTScheduling
END
GO
CREATE TRIGGER TR_AuditTrailForPostPNDTScheduling ON Tbl_PostPNDTScheduling FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_PostPNDTScheduling'
