...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForCentralLabToMolLabShipments' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForCentralLabToMolLabShipments
END
GO
CREATE TRIGGER TR_AuditTrailForCentralLabToMolLabShipments ON Tbl_CentralLabShipments FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_CentralLabShipments'
