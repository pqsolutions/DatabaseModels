...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSubjectParent' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSubjectParent
END
GO
CREATE TRIGGER TR_AuditTrailForSubjectParent ON Tbl_SubjectParentDetail FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_SubjectParentDetail'
