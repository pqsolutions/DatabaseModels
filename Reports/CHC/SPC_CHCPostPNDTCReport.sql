...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_CHCPostPNDTCReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_CHCPostPNDTCReport -- '','',2,0,1,1
END
GO
CREATE PROCEDURE [dbo].[SPC_CHCPostPNDTCReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@CHCID INT
