...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_CHCPNDTReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_CHCPNDTReport -- '','',2,0,1,1
END
GO
CREATE PROCEDURE [dbo].[SPC_CHCPNDTReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@CHCID INT
