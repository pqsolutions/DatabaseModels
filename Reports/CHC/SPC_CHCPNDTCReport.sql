...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_CHCPNDTCReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_CHCPNDTCReport  --'','',2,0,1,5
END
GO
CREATE PROCEDURE [dbo].[SPC_CHCPNDTCReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@CHCID INT
