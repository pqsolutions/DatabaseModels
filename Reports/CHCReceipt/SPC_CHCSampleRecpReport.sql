...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_CHCSampleRecpReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_CHCSampleRecpReport 
END
GO
CREATE PROCEDURE [dbo].[SPC_CHCSampleRecpReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@CHCID INT
