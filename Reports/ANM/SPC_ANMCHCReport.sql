...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_ANMCHCReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_ANMCHCReport  --'','',1,0,0,5
END
GO
CREATE PROCEDURE [dbo].[SPC_ANMCHCReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@ANMID INT
