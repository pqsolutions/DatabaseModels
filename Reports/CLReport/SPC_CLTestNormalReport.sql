...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_CLTestNormalReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_CLTestNormalReport 
END
GO
CREATE PROCEDURE [dbo].[SPC_CLTestNormalReport]
(
	@FromDate VARCHAR(50)
	,@ToDate VARCHAR(50)
	,@SubjectType INT
