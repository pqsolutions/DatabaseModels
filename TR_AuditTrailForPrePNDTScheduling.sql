...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForPrePNDTScheduling' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForPrePNDTScheduling
END
GO
CREATE TRIGGER TR_AuditTrailForPrePNDTScheduling ON Tbl_PrePNDTScheduling FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_PrePNDTScheduling'
