...
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_FetchTrackingSubjectReport' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_FetchTrackingSubjectReport 
END
GO
CREATE PROCEDURE [dbo].[SPC_FetchTrackingSubjectReport]
(	
