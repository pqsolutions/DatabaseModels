...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForMolecularTestResult' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForMolecularTestResult
END
GO
CREATE TRIGGER TR_AuditTrailForMolecularTestResult ON Tbl_MolecularTestResult FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_MolecularTestResult'
