...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSSTestResult' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSSTestResult
END
GO
CREATE TRIGGER TR_AuditTrailForSSTestResult ON Tbl_SSTestResult FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_SSTestResult'
