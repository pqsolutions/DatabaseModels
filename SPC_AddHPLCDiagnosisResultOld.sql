...
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_AddHPLCDiagnosisResultOld' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_AddHPLCDiagnosisResultOld 
END
GO
CREATE PROCEDURE [dbo].[SPC_AddHPLCDiagnosisResultOld] 
(
