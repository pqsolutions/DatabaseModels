...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForSampleCollection' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForSampleCollection
END
GO
CREATE TRIGGER TR_AuditTrailForSampleCollection ON Tbl_sampleCollection FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_sampleCollection'
