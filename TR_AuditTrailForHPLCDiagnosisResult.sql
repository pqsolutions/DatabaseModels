...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForHPLCDiagnosisResult' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForHPLCDiagnosisResult
END
GO
CREATE TRIGGER TR_AuditTrailForHPLCDiagnosisResult ON Tbl_HPLCDiagnosisResult FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_HPLCDiagnosisResult'
