...
GO
---- Add the new sample collection of subject which are damaged sample or timout expiry sample

IF EXISTS (SELECT 1 FROM sys.objects WHERE name='SPC_AddANMSampleRecollection' AND [type] = 'p')
BEGIN
	DROP PROCEDURE SPC_AddANMSampleRecollection
END
GO
