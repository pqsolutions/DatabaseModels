...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForHPLCTestResult' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForHPLCTestResult
END
GO
CREATE TRIGGER TR_AuditTrailForHPLCTestResult ON Tbl_HPLCTestResult FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_HPLCTestResult'
