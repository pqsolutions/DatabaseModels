...
GO
IF EXISTS (SELECT 1 FROM sys.objects WHERE name='TR_AuditTrailForMTPTest' AND [type] = 'tr')
BEGIN
	DROP TRIGGER TR_AuditTrailForMTPTest
END
GO
CREATE TRIGGER TR_AuditTrailForMTPTest ON Tbl_MTPTest FOR UPDATE,INSERT
AS
