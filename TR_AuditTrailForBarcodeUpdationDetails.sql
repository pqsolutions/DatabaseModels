...
GO
/****** Object:  Trigger [dbo].[TR_AuditTrailForBarcodeUpdationDetails]    Script Date: 23-03-2021 09:10:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TRIGGER [dbo].[TR_AuditTrailForBarcodeUpdationDetails] ON [dbo].[Tbl_BarcodeUpdationDetails] FOR UPDATE,INSERT
AS
    ...
    SELECT @TableName = 'Tbl_BarcodeUpdationDetails'
   ...
   -- date 
	...
	BEGIN
		...
		BEGIN
			SELECT @Type = 'U'
			SELECT @UpdatedBy = CreatedBy from Inserted
		END
		ELSE
		BEGIN
			SELECT @Type = 'I'
